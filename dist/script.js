...
window.addEventListener('DOMContentLoaded', () => {
  ...
  mainSlider.render();
  const mainModuleSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    slidesParent: '.moduleapp',
    nextBtn: '.nextmodule',
    prevBtn: '.prevmodule'
  });
  ...
  new _modules_videoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]('.module .play', '.overlay').init();
  const differenceOld = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officer__card-item', '.plus');
  differenceOld.render();
  const differenceNew = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officer__card-item', '.plus');
  differenceNew.render();
  const form = new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"]('form', 'input', '[name="email"]', '[name="phone"]');
  form.render();
  const accordion = new _modules_accordion__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus__content');
  accordion.render();
...
class SliderMain extends _slider__WEBPACK_IMPORTED_MODULE_1__["default"] {
